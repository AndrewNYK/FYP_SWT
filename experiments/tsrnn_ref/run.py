...
parser.add_argument('--is_training', default=True, action='store_true', help='training or testing')
...
parser.add_argument('--test_interval', type=int, default=40, help='number of iters for test.') #default=1000
